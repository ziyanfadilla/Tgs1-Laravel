    ...
    {{-- <div class="container">
        <div class="card mt-5">
            <div class="row no-gutters">
                <div class="col-md-4">
                    <img src="{{asset('img1.jpeg')}}" style="width: 50%; height: auto; object-fit: cover">
                </div>
                <div class="col">
      ...
      <div class="card p-3">
          <div class="d-flex align-items-center">
              ...
              <div class="ml-3 w-100">
                  ...
                  <div class="button mt-2 d-flex flex-row align-items-center"> <button class="btn btn-sm btn-outline-primary w-100" onclick="window.location.href='https://www.instagram.com/zynfadilla/'">Instagram</button> <button class="btn btn-sm btn-primary w-100 ml-2">Youtube</button> </div>
              </div>
          </div>
      </div>
  </div>
